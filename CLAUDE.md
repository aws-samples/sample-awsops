...
## ADRs / Decisions
Architecture decision records (ADRs 001–020 + the BASELINE invariant register) are maintained in the private upstream repository and are **not part of this public tree** — docs here cite ADRs by number for traceability only. The invariants that bind contributions to this repo:
