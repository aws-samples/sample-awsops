<!-- generated-by: co-agent · source: CLAUDE.md · claude-md-sha: 4c9759875c93 · generated-at: 2026-09-15 · DO NOT EDIT — edit CLAUDE.md then run /co-agent sync-context -->
...
- The role has **no privilege on any table/column in `public`** — data is exposed only through
  ...
  anything to `public`.
- `meta.row` can retain nested provider secrets, including CloudFront origin CustomHeaders,
  in both old and new generations. Top-level projection is not sanitization; never expose raw `row`.
