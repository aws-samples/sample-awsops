...
Deploy Web uses the controller/read transport and forces the automatic SQL policy
for every web-driven migration. Standalone operator migrations retain their explicit
manual mode. The runner reports lock contention immediately.
