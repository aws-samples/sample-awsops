...
| [release-safety-primitives.md](release-safety-primitives.md) | Unwired bounded web reads/controller, opt-in pending-SQL admission, immediate migration contention and operator recovery (ADR-001/005/021) |
