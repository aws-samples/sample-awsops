...
| [ci-staged-deployment.md](ci-staged-deployment.md) | Staged dev deployment — existing-stack migration ordering, fresh bootstrap, manual DNS, identity preflight, digest verification and encrypted failure diagnostics |
