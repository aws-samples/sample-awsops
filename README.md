...
Stats: 41 pages, 99 API routes, 112 components (`web/`), 21 consolidated ADRs, Terraform-managed (`terraform/foundation`, no CDK).
...
현황: 41 페이지, 99 API 라우트, 112 컴포넌트(`web/`), 21개 통합 ADR, Terraform 관리(`terraform/foundation`, CDK 없음).
