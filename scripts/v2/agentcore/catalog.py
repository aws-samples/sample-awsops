...
TARGETS = {
    ...
    "prometheus-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "prometheus_query", "description": "Instant PromQL query at a single time; collectionStatus is ok/empty/partial/unknown/error. Keep partial observations with caveats; never infer absence or full coverage from partial/unknown/error. Supports bounded vector/matrix and scalar/string results.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "time": _p("string", "Eval time: unix/ISO (default now)")}, "required": ["query"]}},
            {"name": "prometheus_query_range", "description": "Range PromQL query over a time window; collectionStatus is ok/empty/partial/unknown/error. Keep partial observations with caveats; never infer absence or full coverage from partial/unknown/error.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "start": _p("string", "1h/30m or unix/ISO (default now-1h)"), "end": _p("string", "unix/ISO (default now)"), "step": _p("string", "Step seconds (default 60)")}, "required": ["query"]}},
    ...
    "mimir-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "mimir_query_range", "description": "Range PromQL query; collectionStatus is ok/empty/partial/unknown/error. Keep partial observations with caveats; never infer absence or full coverage from partial/unknown/error.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "start": _p("string", "1h/30m or unix (default now-1h)"), "end": _p("string", "unix (default now)"), "step": _p("string", "Step seconds (default 60)")}, "required": ["query"]}},
