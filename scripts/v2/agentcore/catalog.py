...
TARGETS = {
    ...
    "tempo-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "tempo_get_trace", "description": "Fetch a trace by hex ID. Oversized payloads return bounded OTLP span projection with truncated=true; normal payloads remain unchanged.", "inputSchema": {"type": "object", "properties": {"trace_id": _p("string", "Hex trace ID")}, "required": ["trace_id"]}},
