...
TARGETS = {
    ...
    "prometheus-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "prometheus_query", "description": "Instant PromQL query at a single time collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage. Instant queries also support one bounded scalar/string sample; incomplete pairs do not prove a value.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "time": _p("string", "Eval time: unix/ISO (default now)")}, "required": ["query"]}},
            {"name": "prometheus_query_range", "description": "Range PromQL query over a time window collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage. Range queries require vector/matrix series; unsupported or malformed result shapes remain unknown.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "start": _p("string", "1h/30m or unix/ISO (default now-1h)"), "end": _p("string", "unix/ISO (default now)"), "step": _p("string", "Step seconds (default 60)")}, "required": ["query"]}},
            {"name": "prometheus_labels", "description": "List label names. collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage.", "inputSchema": {"type": "object", "properties": {}}},
            {"name": "prometheus_series", "description": "Find series matching a selector. collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage.", "inputSchema": {"type": "object", "properties": {"match": _p("string", "Series selector e.g. up{job=\"x\"}")}, "required": ["match"]}},
    ...
    "tempo-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "tempo_get_trace", "description": "Fetch a trace by hex ID. Oversized valid responses retain a bounded_otlp projection with truncated=true. If no span fits, tracePayloadTruncated=true marks an explicit partial byte omission. Neither proves complete/empty; useful siblings may publish partial data. Unmarked empty/error children remain unconfirmed.", "inputSchema": {"type": "object", "properties": {"trace_id": _p("string", "Hex trace ID")}, "required": ["trace_id"]}},
    ...
    "mimir-mcp-target": {
        ...
        "tools": [
            ...
            {"name": "mimir_query_range", "description": "Range PromQL query. collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage. Range queries require vector/matrix series; unsupported or malformed result shapes remain unknown.", "inputSchema": {"type": "object", "properties": {"query": _p("string", "PromQL"), "start": _p("string", "1h/30m or unix (default now-1h)"), "end": _p("string", "unix (default now)"), "step": _p("string", "Step seconds (default 60)")}, "required": ["query"]}},
            {"name": "mimir_labels", "description": "List label names. collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage.", "inputSchema": {"type": "object", "properties": {}}},
            {"name": "mimir_series", "description": "Find series matching a selector. collectionStatus ok/empty denotes complete results; partial/unknown/error or truncated output must not support an absence claim. Useful partial rows do not establish full coverage.", "inputSchema": {"type": "object", "properties": {"match": _p("string", "Series selector")}, "required": ["match"]}},
