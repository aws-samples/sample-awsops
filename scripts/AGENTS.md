<!-- generated-by: co-agent · source: CLAUDE.md · claude-md-sha: 761c4d1a3812 · generated-at: 2026-09-14 · DO NOT EDIT — edit CLAUDE.md then run /co-agent sync-context -->
...
- `ci_web_read.py` / `ci_web_deploy.py` are unwired. Only typed transient reads
