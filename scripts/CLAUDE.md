...
## Key Files
- `v2/ci_web_read.py` and `v2/ci_web_deploy.py` are unwired web release primitives.
...
- `v2/automatic-migration-policy.mjs` admits a conservative additive SQL subset only
  when `AUTOMATIC_MIGRATION=1`. Check all actual pending files before pending SQL, ledger upgrades or reader
