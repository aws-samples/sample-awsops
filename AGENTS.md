<!-- generated-by: co-agent · source: CLAUDE.md · claude-md-sha: 4b17e7a079e4 · generated-at: 2026-09-14 · DO NOT EDIT — edit CLAUDE.md then run /co-agent sync-context -->
...
Dev Deploy Web requires the reusable private migration before promotion. Only its exact
samples/dev caller may opt migrations into push events; standalone/AgentCore stay dispatch-only.
