...
description: "从单一 Gateway 全面重构为 7 个基于角色的 Gateway。19 个 Lambda、125 个 MCP 工具、Sonnet 意图分类。"
authors: [awsops]
...
:::tip 性能提升要点
拆分 Gateway 后，代理需要参考的工具数量减少，**工具选择准确率**和**响应速度**均得到提升。
在单一 Gateway（125 个工具）下 LLM 需要花时间寻找合适的工具，而在 Container Gateway（24 个工具）下可以立即选中相关工具。
:::
