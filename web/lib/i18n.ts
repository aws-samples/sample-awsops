...
const MESSAGES: Record<Lang, Dict> = {
  ...
  'group.compute.eks': 'EKS',
    ...
    'nav.networkPathCheck': '경로 점검',
    'group.network.securityGroup': '보안 그룹',
    'nav.sgSecurityGroups': '보안 그룹',
    'nav.sgRules': '규칙',
    'nav.sgUsage': '사용 현황',
    'nav.jobs': '작업',
    'nav.cost': '비용',
  ...
  'group.compute.eks': 'EKS',
    ...
    'nav.directConnect': 'Direct Connect',
    'nav.networkFirewall': 'Network Firewall',
    'nav.networkPathCheck': 'Path Check',
    'group.network.securityGroup': 'Security Group',
    'nav.sgSecurityGroups': 'Security Groups',
    'nav.sgRules': 'Rules',
    'nav.sgUsage': 'Usage',
    'nav.jobs': 'Jobs',
    'nav.cost': 'Cost',
  ...
  'group.compute.eks': 'EKS',
    ...
    'nav.directConnect': 'Direct Connect',
    'nav.networkFirewall': 'Network Firewall',
    'nav.networkPathCheck': '路径检查',
    'group.network.securityGroup': '安全组',
    'nav.sgSecurityGroups': '安全组',
    'nav.sgRules': '规则',
    'nav.sgUsage': '使用情况',
    'nav.jobs': '任务',
    'nav.cost': '费用',
  ...
  ja: {
    ...
    'nav.directConnect': 'Direct Connect',
    'nav.networkFirewall': 'Network Firewall',
    'nav.networkPathCheck': 'パスチェック',
    'group.network.securityGroup': 'セキュリティグループ',
    'nav.sgSecurityGroups': 'セキュリティグループ',
    'nav.sgRules': 'ルール',
    'nav.sgUsage': '使用状況',
    'nav.jobs': 'ジョブ',
    'nav.cost': 'コスト',
    ...
    'palette.integrationHint': 'データソース · コネクタ · スキル',
    ...
    'scope.accountCount': '{n} 個のアカウント',
    'scope.host': 'ホスト',
    'scope.allEnabledRegions': '有効なすべてのリージョン',
    'scope.regionCount': '{n} 個のリージョン',
    'scope.noRegions': 'リージョンなし',
    'scope.includeGlobal': 'グローバルサービスを含む',
    'chat.untarget': 'セクション指定を解除',
    'chat.placeholder': 'メッセージを入力…  ( / でセクションを指定 · Shift+Enter で改行 )',
