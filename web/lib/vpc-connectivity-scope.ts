// Supported commercial input regions; never select an SDK default for an unknown scope.
...
export function isVpcConnectivityRegion(value: unknown): value is string {
